...
if GROQ_API_KEY:
    try:
        llm_llama70b = ChatGroq(model_name="groq/llama3-70b-8192", groq_api_key=GROQ_API_KEY)
        print("ChatGroq object initialized successfully.")
        print("llm_llama70b: ", llm_llama70b)
...
stock_researcher = Agent(
    ...
    function_calling_llm=llm_llama70b,
)
